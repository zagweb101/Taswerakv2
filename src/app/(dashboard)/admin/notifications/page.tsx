...
import { Bell, Clock, Award, Wallet, BookOpen, MessageSquare, ShieldCheck } from "lucide-react";
...
export default async function AdminNotificationsPage() {
  ...
  try {
    ...
    console.error("[admin/notifications] DB error:", err);
    dbError = true;
  }
        ...
        <Card className="rounded-2xl border-border/60">
          <CardContent>
            <DashboardEmptyState
              ...
              hint="ستظهر هنا إشعارات النظام وتذاكر الدعم والمدفوعات"
            />
          </CardContent>
        </Card>
      ) : (
